  ...
  const faqs = [
    {
      ...
      answer: "СБОРКА — это подписочный карьерный клуб для специалистов уровня Middle, Senior и Lead. Внутри: групповые сессии с менторами, разбор резюме, мок-собеседования, переговоры о зарплате и командные соревнования по поиску работы. Всё в Telegram, живые сессии.",
    },
    {
      question: "Сколько стоит подписка на СБОРКУ?",
      answer: "Три тарифа: СТАРТ 4 900 руб/мес (групповые сессии + соревнование), ПРОРЫВ 9 900 руб/мес (+ разбор резюме + мок-собеседования), VIP 15 900 руб/мес (+ персональный ментор). Триальный период 7 дней бесплатно.",
    },
    {
    ...
    {
      question: "Чем СБОРКА отличается от курсов по трудоустройству?",
      answer: "Курсы дают записанные лекции. СБОРКА — это живая среда: ты работаешь с менторами в реальном времени, получаешь обратную связь на своё резюме и проходишь мок-собеседования. Плюс командное соревнование, которое не даёт расслабиться.",
    },
    {
      question: "Кто менторы в СБОРКЕ?",
    ...
    {
      question: "Подходит ли СБОРКА для смены профессии?",
    ...
    },
    {
      ...
      answer: "Да. Триальный период — 7 дней бесплатно. Также проводим бесплатные вебинары, на которые можно зарегистрироваться через бот @Sborka_work_bot.",
    },
    {
