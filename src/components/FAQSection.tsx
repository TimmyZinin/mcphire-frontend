  ...
  const faqs = [
    {
      ...
      answer: "MCPHire — AI-платформа для поиска IT-работы с MCP-протоколом. Наш партнёр СБОРКА (sborka.work) помогает подготовиться к собеседованиям: менторы, мок-интервью, разбор резюме, переговоры о зарплате. Подписка от 4 900 руб/мес.",
    },
    {
