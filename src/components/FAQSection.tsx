  ...
  const faqs = [
    {
      ...
      answer: "5-6 часов в неделю: 2 групповые сессии + ежедневный трекинг + самостоятельная работа. Это минимум для реального результата.",
    },
    {
      question: "Это онлайн-курс?",
      answer: "Нет. Это живая рабочая среда с регулярными сессиями, трекингом и обратной связью от экспертов. Никаких записанных видео «посмотри когда-нибудь».",
    },
    {
    ...
    },
    {
      ...
      answer: "Если за 2 месяца активной работы ты не получишь ни одного оффера — вернём деньги. Мы уверены в системе.",
    },
    {
