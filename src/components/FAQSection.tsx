  ...
  const faqs = [
    {
      ...
      answer: "MCPHire — это подписочный MCPHireый клуб для специалистов уровня Middle, Senior и Lead. Внутри: групповые сессии с менторами, разбор резюме, мок-собеседования, переговоры о зарплате и командные соревнования по поиску работы. Всё в Telegram, живые сессии.",
    },
    {
    ...
    },
    {
      ...
      answer: "Вебинары проходят в Zoom, обычно по вечерам (18:00-19:30 МСК). Темы: как устроен найм, разбор резюме, подготовка к собеседованиям, переговоры о зарплате. Участие бесплатное, регистрация через Telegram-бот @mcphire_bot.",
    },
    {
    ...
    },
    {
      ...
      answer: "Да. Мы проводим бесплатные открытые вебинары, где можно познакомиться с менторами и задать вопросы. Регистрация через Telegram-бот @mcphire_bot.",
    },
    {
