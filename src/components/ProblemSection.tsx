import illustrationProblem from "@/assets/illustration-problem.jpg";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-12">
            ...
            <h2 className="heading-lg">
              Если коротко —{" "}
              <span className="text-primary">сейчас тяжело почти всем.</span>
            </h2>
            ...
            {/* Quote block */}
            <div className="quote-block space-y-2">
              <p className="text-primary">Проблема не в тебе.</p>
          ...
          <div className="relative">
            <img 
              ...
              alt="Иллюстрация проблемы поиска работы"
