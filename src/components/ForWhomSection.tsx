...
const ForWhomSection = () => {
  ...
  const notFor = [
    "Тем, кто ищет волшебную таблетку — здесь работают системно",
    "Тем, кто не готов вкладывать 5-6 часов в неделю",
    "Тем, кто ожидает, что всё сделают за него",
    "Тем, кто пока не готов к честной обратной связи",
  ];
