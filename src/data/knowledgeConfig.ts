...
export const EXPERT_QUOTES = {
  tim: [
    { text: "Рынок IT в 2026 году — это не про количество вакансий, а про качество подготовки. Те, кто подходит системно, получают офферы на 20-40% выше рынка.", author: "Тим Зинин", role: "Co-founder MCPHire, AI & Product" },
    { text: "Резюме — это продающий документ, не автобиография. Метрики, результаты, конкретика. Рекрутер тратит 7 секунд — каждое слово должно работать.", author: "Тим Зинин", role: "Co-founder MCPHire, AI & Product" },
    { text: "AI не заменяет разработчиков — он меняет требования. Кто умеет работать с AI-инструментами, получает +30% к рыночной стоимости.", author: "Тим Зинин", role: "Co-founder MCPHire, AI & Product" },
    { text: "Выгорание — это не слабость, а сигнал. В MCPHire мы видим: 70% случаев выгорания решаются сменой окружения, а не профессии.", author: "Тим Зинин", role: "Co-founder MCPHire, AI & Product" },
    { text: "Удалёнка — это не скидка к зарплате. Senior-специалисты на удалёнке часто получают больше, чем офисные, потому что работают на московские компании из регионов.", author: "Тим Зинин", role: "Co-founder MCPHire, AI & Product" },
  ],
  kristina: [
    { text: "За 8 лет в рекрутинге я видела тысячи резюме. Главная ошибка — писать про обязанности вместо результатов. Компаниям нужны достижения, а не описание должности.", author: "Кристина Жукова", role: "Co-founder MCPHire, 8 лет в рекрутинге" },
    { text: "Собеседование — это переговоры, а не экзамен. Лучшие кандидаты задают вопросы, а не просто отвечают. Это показывает зрелость и интерес.", author: "Кристина Жукова", role: "Co-founder MCPHire, 8 лет в рекрутинге" },
    { text: "80% вакансий закрываются через нетворкинг, а не через отклики на hh.ru. Системный поиск — это не только сайты, но и связи, рекомендации, прямые выходы на нанимающих менеджеров.", author: "Кристина Жукова", role: "Co-founder MCPHire, 8 лет в рекрутинге" },
    { text: "Торговаться о зарплате — нормально. Рекрутеры ОЖИДАЮТ этого. Кандидат, который не торгуется, вызывает больше вопросов, чем тот, кто просит на 20% больше.", author: "Кристина Жукова", role: "Co-founder MCPHire, 8 лет в рекрутинге" },
    { text: "Карьерный рост — это не только про hard skills. После Senior уровня 80% промо зависят от коммуникации, менторства и умения влиять на бизнес-решения.", author: "Кристина Жукова", role: "Co-founder MCPHire, 8 лет в рекрутинге" },
  ],
};
