          ...
          <div className="space-y-6 max-w-3xl">
            {[
              ...
              },
              {
                ...
                a: "Каждый партнёр получает уникальную ссылку вида t.me/mcphire_bot?start=ref_XXXXX. Когда человек переходит по ней и оплачивает подписку, система автоматически привязывает его к вам.",
              },
              {
